...
const { loginValidationSchema, googleLoginValidationSchema } = require('~/validation/schemas/login')
...
router.post(
  '/google',
  validationMiddleware(googleLoginValidationSchema),
  asyncWrapper(authController.googleLogin)
)
